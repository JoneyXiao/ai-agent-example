...
const WeatherToolName = "GetWeather"
...
// WeatherTool defines the OpenAI tool for getting weather information
func WeatherTool() openai.Tool {
	funcdefine := openai.FunctionDefinition{
		Name:        WeatherToolName,
		Description: WeatherToolDescription,
		Parameters:  WeatherToolParameters,
	}

	return openai.Tool{Type: "function", Function: &funcdefine}
}

func Tools(name string, description string, parameters string, tools []openai.Tool) []openai.Tool {
	funcdefine := openai.FunctionDefinition{
		Name:        name,
	...
	tool := openai.Tool{Type: "function", Function: &funcdefine}
